				...
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
					<form action="contact_process.php" method="POST">
						...
						<div class="bor8 m-b-20">
							<input class="stext-111 cl2 plh3 size-116 p-lr-30" type="text" name="name" placeholder="Your Full Name" required>
						</div>

						<div class="bor8 m-b-20">
							<input class="stext-111 cl2 plh3 size-116 p-lr-30" type="text" name="subject" placeholder="Subject" required>
						</div>
